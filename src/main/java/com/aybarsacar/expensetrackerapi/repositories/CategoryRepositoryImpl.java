...
public class CategoryRepositoryImpl implements CategoryRepository {
  ...
  public static final String SQL_CREATE = "INSERT INTO ET_CATEGORIES " +
  ...
  public static final String SQL_DELETE = "DELETE FROM ET_CATEGORIES " +
      "WHERE USER_ID = ? AND CATEGORY_ID = ?";

  public static final String SQL_DELETE_ALL_TRANSACTIONS = "DELETE FROM ET_TRANSACTIONS " +
      "WHERE CATEGORY_ID = ?";
  ...
  public Category findById(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
    ...
    try {
      ...
      return jdbcTemplate.queryForObject(
          SQL_FIND_BY_ID, new Object[]{userId, categoryId}, categoryRowMapper
      );
  ...
  public Integer create(Integer userId, String title, String description) throws EtBadRequestException {
    ...
    try {
      //    using keyhodler to get the primary key
